...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(usage="it's usage tip.",description="PSPred-AEF: Adaptive learning embedding features to improve the predictive performance of SARS-CoV-2 phosphorylation sites")
    ...
    print("Model loading......")
    model = PSPred_model.PSPred_AEF().to(device)
